    ...
    render={data => (
      ...
      >
        ...
        `}>
          ...
          <a
            href={`https://www.facebook.com/Holm-School-233392397290339/`}
            className={cx(css`
        ...
        {children}
        <div>
          <a href="https://www.negativland.com/news/wp-content/uploads/text/negativland-two_relationships_essay.pdf"><img src={public_domain_small} className={css`margin-top: 10px;margin-left: 20px; width:120px;margin-right: 30px;`}/></a>

          {/* <Link to={'/'} className={css`text-decoration: none;`}><span className={cx(holmSchool)}>Holm School</span></Link> */}
        </div>
      </div>
    )}
  />
