...
export default ({ data }) => (
  <Layout>
    ...
    `}>
      ...
      <p>A lot of people in poverty have cell phones nowadays. Personally I lucked out by having my parents pay for my cell phone while I was unemployed and studying computer science, and I realize how lucky I am giving that cell phones are a huge expense that I couldn't pay on my own. But if you do have a cell phone, you can use it for an on-the-go internet connection using a personal hotspot. Your data plan might prevent you from watching video tutorials, but if you have a free wifi from somewhere during the day, you can download your video tutorials during the day and use your cell phone as a internet connection at home for low-bandwidth browsing such as text tutorials or OER downloads. My friend at the moment is forgoing cable at home and is using an unlimited-data T-Mobile connection as his main internet at home as a fuck-you to Time Warner for campaigning to end net neutrality. I think this is definitely what people are going to do in the future, it might be a little early for its time, but if you do the research and experimentation perhaps this is a good way to save the $45/month bandwidth charge. If you spend all day at the public library (or a makerspace) using their wifi, hoarding the high-bandwidth stuff for later, then for the few hours you spend at home at night before you go to bed, if you keep it low-bandwidth perhaps a 5G connection is enough.</p>
      ...
      <p>That said, UoPeople has its downsides. First, I would say that it is incredibly expensive given that it is based around OER that is openly available. You can just go to <a href="http://saylor.org">http://saylor.org</a> and read all the computer science classes, which are the same reading materials as UoPeople classes. Why pay money for free OER? Just read it on your own and save $4k. I'm tempted to say UoPeople is just a way to monetize OER, without any reward like regional accreditation. I've also heard that UoPeople tests are incredibly easy. That's a shame, I really wish they would keep their curricula rigorous and challenging. Having a pud CS class without access to a professor to ask questions isn't worth the money, to be honest, when you could just study a textbook and consult OpenCourseWare for free. If you aren't even challenged by your class, why not just independently study? The degree isn't regionally accredited, so it's practically worthless.</p>

      <p>$4k is a lot of money to spend on computer science online study. I went to two years of computer science classes at a four year university in my hometown for $8k total. Granted, I didn't get a degree, but I have transferable classes if I ever feel the need to get a b.s. in CS (which I don't), and I have professors that can act as references on my resume. $4k is a laughable amount compared to what you get in return: Whereas I could fund a <a href="http://teamtreehouse.com">http://teamtreehouse.com</a> account for 11 years with $4k, and have access to proprietary video tutorials for so many years that I could complete the entire curriculum and learn about ~8 programming languages and a dozen more web frameworks, UoPeople just offers access to otherwise free OER from Saylor and doesn't even provide video tutorials or access to a professor (who can learn CS by emailing a volunteer professor?) or even video conferences for all the students each day. They don't offer anything that requires high bandwidth in order to support students in Africa, so you're not exactly utilizing technology to improve your student success. It's completely text-based, and texts that are free online anyway. Sorry, UoPeople is too bare bones and redundant to justify $4k unless you have no other option in your hometown to study CS at a community college or college and you're really driven to have a degree. If you live in a rural setting or all the colleges in your hometown are private or something, then maybe UoPeople can be justified. In my opinion, however, you should save your money and just independently study CS online and attempt to get a job without a degree at all. If you study hard for four years and learn 8+ languages and web frameworks, then you're going to have a killer resume that gets you an interview even if you don't have a degree. UoPeople operates under the assumption that people need degrees, and I simply don't believe that to be the case. If you resume is solid, you have a lot of good source code up on github, you've done all your homework, and you've studied 10+ hours a day for 4 years, you're going to be able to get a job somewhere that'll reimburse your tuition so you can come out of working there with a degree. If you're actually not that poor, and you're willing to play risky with $4k if you think that's enough to snag a job (and maybe you like the structure of having daily homework, even if that homework is pud), then go for it! Otherwise buy 11 years of Treehouse (assuming it isn't free already from your public library). In reality you'll need only two or three years of Treehouse.</p>

      <p>UoPeople is a good idea in theory but this iteration just isn't enough to cut it. Computer Science isn't a joke where you can put someone through some pud classes available from Saylor, which doesn't even use a textbook (it's just a sporadic splattering of free resources off the web) and expect anyone to take the degree seriously. Maybe there will come a day when quality OER textbooks allow for a few years of CS curriculum that is as difficult as classes at an elite university. But that moment is not now, and charging $4k for the luxury of reading unorganized OER that is otherwise free isn't a good use of anyone's money or time. Make the degree as challenging as Stanford or Carnegie Mellon and flunk all the people who are looking for an easy degree and unwilling to put in the time and work, and then you'll turn out smart programmers. If I were UoPeople I would focus on making my CS curriculum one of the most challenging in the world. Then people would pay $4k.</p>

      <p>Recommendation: Forgo UoPeople and try to independently study CS for cheap using the curriculum provided by this website. Go to community college if there is one in your hometown that you can live at home and attend. It's more important that you thoroughly understand programming languages in order to get a job than it is having a degree. Understanding how to code comes from reading books, doing problem sets each chapter, or developing personal projects on heroku, not from reading Saylor.org OER. UoPeople exists for people without high bandwidth. Given that people in America typically have access to broadband somehow at their public library, relying on low-bandwidth learning methods in the age of video tutorials, YouTube, and OCW classes is quaint.</p>
      ...
      <p>It is a sensible thing to buy your clothes used from Goodwill or Salvation Army (or whatever cheap thrift stores your town might have). These are kind of shitty companies, morality-wise, but ultimately there is no one else offering the service that they do. I recently lost two dress sizes due to dieting and replaced my entire closet for $300 from Goodwill and Salvation Army. Each piece was a fancy brand name.</p>
